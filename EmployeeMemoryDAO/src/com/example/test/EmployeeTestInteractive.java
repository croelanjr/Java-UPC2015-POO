...
import com.example.model.EmpleadoException;
...
public class EmployeeTestInteractive {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try(EmpleadoDAO dao =  factory.crearEmpleadoDAO();
        ...
        do {
            ...
            System.out.println("Error recurso cerrado " + e.getClass().getName());
            System.out.println("Mensaje: " + e.getMessage());
        }
    }

    public static boolean executeMenu(BufferedReader in, EmpleadoDAO dao) throws IOException, EmpleadoException {
        Empleado emp;
        String action;
        int id;
